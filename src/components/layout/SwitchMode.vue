...
<template>
    <div class="switch-mode absolute bottom-16 right-6 tablet:bottom-17 tablet:right-7 laptop:bottom-18 laptop:right-8 flex items-center gap-4">
        <div class="switch-mode__label text-[1rem] tablet:text-[1.2rem] laptop:text-[1.4rem]">Switch Mode</div>
