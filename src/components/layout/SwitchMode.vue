...
<template>
    <div class="switch-mode absolute bottom-26 right-6 tablet:bottom-27 tablet:right-7 laptop:bottom-28 laptop:right-8 flex items-center gap-4">
        <div class="switch-mode__label text-[1.6rem]">Switch Mode</div>
