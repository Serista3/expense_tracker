...
<template>
    <Transition name="modal-transition">
        <div v-if="activeModal" 
            ...
            @click.self="activeModal = false"> <div class="modal-content max-w-[40rem] w-full bg-light dark:bg-dark dark:text-light p-14 shadow-lg rounded-[1rem] relative">
                <h1 class="text-5xl font-semibold text-dark dark:text-light text-center mb-12 leading-[1.4]">{{ nameModal }}</h1>
                <slot></slot>
